      ...
      <div className="min-h-screen flex justify-center items-center">
        <div className="md:w-1/2 px-48">
          ...
          <div className="my-4 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-neutral-300 after:mt-0.5 after:flex-1 after:border-t after:border-neutral-300 dark:before:border-neutral-500 dark:after:border-neutral-500">
            <p className="text-[#D3D3D3] mx-4 mb-0 text-center font-semibold dark:text-white">
              Continue With
            </p>
          </div>
          <button className="bg-white border py-2 w-full rounded-[8px] mt-5 flex justify-center items-center text-sm hover:scale-105 duration-300 hover:bg-[#60a8bc4f] font-medium">
            <svg
              className="mr-3"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 48 48"
